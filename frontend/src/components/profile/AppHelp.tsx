  ...
  return (
    <div className="h-full min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col">
      ...
      <div className="bg-white dark:bg-gray-950 border-b border-gray-200 dark:border-gray-800 p-4 flex items-center gap-3">
        ...
        <h1 className="text-xl font-bold text-gray-900 dark:text-white">How It Works</h1>
      </div>
      ...
      <div className="flex-1 overflow-auto p-6 space-y-6">
        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">1. Scan Barcode</h3>
        ...
        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">2. Check Safety</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">3. Match Diet</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
        ...
        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-200 dark:border-gray-800">
          <div className="flex items-start gap-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900 dark:text-white mb-2">4. View Results</h3>
              <p className="text-gray-600 dark:text-gray-400 text-sm leading-relaxed">
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-blue-50 dark:from-emerald-900/20 dark:to-blue-900/20 rounded-2xl p-6 border-2 border-emerald-200 dark:border-emerald-800">
          <h3 className="font-bold text-gray-900 dark:text-white mb-2">Data Sources</h3>
